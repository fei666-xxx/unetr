...
class MaskFormer(nn.Module):
    ...
    def __init__(
        ...
        [
            ...
            transforms.Rand3DElastic(prob=1.0, mode='bilinear', padding_mode='zeros',
                                     rotate_range=(np.pi/36,np.pi/36,np.pi/36), translate_range=(10, 10, 10), scale_range=(0.1, 0.1, 0.1), shear_range=(0.1,0.1,0.1),
