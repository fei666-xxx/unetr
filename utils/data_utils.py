...
def get_loader(args):
    ...
    train_transform = transforms.Compose(
        [
            ...
            #transforms.Rand3DElasticd(keys=["image"], prob=0.5, mode='bilinear', padding_mode='zeros',
                                     #rotate_range=(np.pi/36,np.pi/36,np.pi/4), translate_range=(40, 40, 2), scale_range=(0.15, 0.15, 0.15),
            ...
            #transforms.Resized(keys="image", spatial_size=(144,144,144)),
